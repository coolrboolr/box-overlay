...
const SYSTEM_PROMPT =
  "You are a local assistant that summarizes on-page content, provides a short image tag when helpful, and decides whether the item is an advertisement.";
...
const REMINDER =
  "Respond with strictly valid JSON matching the schema above. Do not include markdown fences, comments, or additional text.";

export function buildPrompt({ text, imageTagHint, hasImage, retry }: PromptInput): string {
